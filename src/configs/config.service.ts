...
export class ConfigService {
  ...
  get redisClusterSlaveRead(): string {
    ...
    const redisClusterSlaveRead = process.env.REDIS_CLUSTER_SLAVE_READ || this.envConfig['REDIS_CLUSTER_SLAVE_READ'] || '';
  ...
  get frontEndDomain(): string {
    return process.env.FE_DOMAIN || this.envConfig['FE_DOMAIN'] || 'https://app.dev.kinsend.io';
  }
